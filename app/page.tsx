      ...
      >
        ...
        >
          ...
          <div className="flex flex-wrap gap-6">
            <a
              href="mailto:neelvp2004@gmail.com"
              className="inline-flex items-center gap-2 font-mono text-sm text-neutral-700 transition-colors hover:text-neutral-950 dark:text-neutral-300 dark:hover:text-white"
            >
