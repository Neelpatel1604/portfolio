  ...
  return (
    ...
    >
      <div className={`mx-auto flex max-w-6xl items-stretch border-l border-r ${border}`}>
        ...
        <div className="hidden items-stretch md:flex">
          {links.map((link) => (
            <a
              key={link.label}
              href={link.href}
              className={`flex items-center border-r px-6 font-mono text-xs uppercase tracking-widest text-neutral-700 transition-colors hover:bg-neutral-100 hover:text-neutral-900 dark:text-neutral-300 dark:hover:bg-neutral-900 dark:hover:text-neutral-100 ${border}`}
            >
              {link.label}
            </a>
          ))}
        ...
        >
          <svg viewBox="0 0 16 16" className="size-4 fill-current text-neutral-700 dark:text-neutral-300" aria-hidden>
        ...
        >
          {links.map((link) => (
            <a
              ...
              className={`flex items-center border-b px-6 py-4 font-mono text-xs uppercase tracking-widest text-neutral-700 hover:bg-neutral-100 dark:text-neutral-300 dark:hover:bg-neutral-900 ${border}`}
            >
              {link.label}
            </a>
          ))}
          <button
            ...
            className={`flex w-full items-center gap-2 border-b px-6 py-4 font-mono text-xs uppercase tracking-widest text-neutral-700 hover:bg-neutral-100 dark:text-neutral-300 dark:hover:bg-neutral-900 ${border}`}
          >
            {mounted && resolvedTheme === "dark"
          ...
          <a
            ...
            rel="noopener noreferrer"
            onClick={() => setOpen(false)}
            className={`flex items-center gap-2 border-b px-6 py-4 font-mono text-xs uppercase tracking-widest text-neutral-700 hover:bg-neutral-100 dark:text-neutral-300 dark:hover:bg-neutral-900 ${border}`}
          >
