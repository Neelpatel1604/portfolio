...
export const projects: Project[] = [
  ...
  {
    title: "MoveMean",
    desc: "RAG platform for video -upload a video, get it transcribed and indexed, then ask questions and get grounded answers backed by AWS serverless infrastructure.",
